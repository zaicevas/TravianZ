...
// Phase 2 (09.09.2026): edit/delete message, polls, emoji
tz_def('GCHAT_EDIT',          'Edit');
tz_def('GCHAT_SAVE',          'Save');
tz_def('GCHAT_CANCEL',        'Cancel');
tz_def('GCHAT_EDITED_TAG',    '(edited)');
tz_def('GCHAT_DELETE',        'Delete');
tz_def('GCHAT_CONFIRM_DELETE', 'Delete this message?');
tz_def('GCHAT_DELETED_PLACEHOLDER', 'Message removed by a moderator.');
tz_def('GCHAT_POLL_TITLE',    'Create a poll');
tz_def('GCHAT_POLL_QUESTION_PLACEHOLDER', 'Question...');
tz_def('GCHAT_POLL_OPTION_PLACEHOLDER', 'Option');
tz_def('GCHAT_POLL_ADD_OPTION', '+ Option');
tz_def('GCHAT_POLL_CREATE',   'Create poll');
...
tz_def('RND_REG_FIXED_QUADRANT',     'All players start in the %s region.');
// homepage "Server Information" box
tz_def('RND_INFO_TITLE',             'Server Information');
tz_def('RND_INFO_SPEED_HEAD',        'Speed');
tz_def('RND_INFO_GAME_SPEED',        'Game speed');
tz_def('RND_INFO_TROOP_SPEED',       'Troop speed');
tz_def('RND_INFO_TRADER_CAPACITY',   'Trader capacity');
tz_def('RND_INFO_WORLD_HEAD',        'World');
tz_def('RND_INFO_MAP_SIZE',          'Map size');
tz_def('RND_INFO_MAP_SIZE_VALUE',    '-%1$d to +%1$d (%2$d x %2$d)');
tz_def('RND_INFO_START_REGION',      'Starting region');
tz_def('RND_INFO_START_REGION_FREE', 'your choice');
tz_def('RND_INFO_PROTECTION',        'Beginner protection');
tz_def('RND_INFO_PLAY_WINDOW',       'Play window');
tz_def('RND_INFO_PLAY_WINDOW_VALUE', '%s daily');
tz_def('RND_INFO_ALWAYS_OPEN',       'always open');
tz_def('RND_INFO_GOLD_HEAD',         'Gold');
tz_def('RND_INFO_START_GOLD',        'Starting gold');
tz_def('RND_INFO_WEEKLY_GOLD',       'Weekly gold');
tz_def('RND_INFO_WEEKLY_GOLD_VALUE', '%d every 7 days');
tz_def('RND_INFO_DATES_HEAD',        'Round');
tz_def('RND_INFO_ROUND_START',       'Round start');
tz_def('RND_INFO_ARTIFACTS',         'Artifacts appear');
tz_def('RND_INFO_ROUND_END',         'Round end');
...
tz_def('RND_RESULTS_TITLE',          'Round results');
tz_def('RND_RESULTS_LIVE_TITLE',     'Artifact race - current standings');
tz_def('RND_RESULTS_ENDED',          'The round ended on %s. These are the final results, frozen at the end of the round.');
tz_def('RND_RESULTS_RUNNING',        'The round is still running and ends on %s. The standings below are live and can still change.');
...
tz_def('RND_RESULTS_RANK',           'Rank');
tz_def('RND_RESULTS_PLAYER',         'Player');
tz_def('RND_RESULTS_ALLIANCE',       'Alliance');
tz_def('RND_RESULTS_MEMBERS',        'Members');
tz_def('RND_RESULTS_SMALL',          'Small');
tz_def('RND_RESULTS_GREAT',          'Great');
tz_def('RND_RESULTS_UNIQUE',         'Unique');
tz_def('RND_RESULTS_SCORE',          'Score');
tz_def('RND_RESULTS_ARTIFACTS',      'Artifacts');
tz_def('RND_RESULTS_VILLAGE',        'Village');
tz_def('RND_RESULTS_SIZE',           'Size');
tz_def('RND_RESULTS_HOLDER',         'Holder');
tz_def('RND_RESULTS_NONE',           'No player holds an artifact.');
tz_def('RND_RESULTS_NATARS',         'Artifacts still held by the Natars: %d');
tz_def('RND_RESULTS_WINNER',         'Winner of the round: %s');
tz_def('RND_RESULTS_WINNER_ALLY',    'Winning alliance: %s');
tz_def('RND_RESULTS_POPULATION',     'Largest empires (population)');
tz_def('RND_RESULTS_POP',            'Population');
